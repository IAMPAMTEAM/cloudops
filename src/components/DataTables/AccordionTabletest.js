...
export default function AccordionTabletest({ tableData, detailTableCol, tableOption }) {
    ...
    return (_jsx("div", { style: { height: 535 }, className: 'ag-theme-quartz', children: _jsx(AgGridReact, { rowData: rowData, columnDefs: columnDefs, defaultColDef: defaultColDef, autoSizeStrategy: autoSizeStrategy, pagination: tableConfig.pagination, paginationPageSize: tableConfig.paginationPageSize, paginationPageSizeSelector: tableConfig.paginationPageSizeSelector, masterDetail: true, detailCellRendererParams: detailCellRendererParams }) }));
}
